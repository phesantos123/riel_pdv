...
<div class="rows  mb-2" id="" style=""> 
    ...
    <div class="col" id="pis_por_perc" >                        
        <small class="text-label">Alíquota PIS (%)</small>
        <input type="text" class="form-campo" name="pPIS"  id="pPIS">
    </div>

    <div class="col-3" id="pis_por_valor" style="display: none">                        
        <small class="text-label">Valor unid trib PIS (R$))</small>
        <input type="text" class="form-campo" name="vAliqProd_pis" id="vAliqProd_pis" >
    </div>
