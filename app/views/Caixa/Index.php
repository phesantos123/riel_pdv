<div class="conteudo-fluido">
			...
			<div class="caixa-titulo py-1 d-flex justify-content-space-between">
				...
				<div>
					<a href="<?php echo URL_BASE ."caixa/create"?>" class="btn btn-verde  d-inline-block"><i class="fas fa-plus-circle mb-0"></i> Adicionar novo</a>
			...
			<div class="col-12">
					...
					?>
						<table cellpadding="0" cellspacing="0" id="dataTable">
                            ...
                            ?>                      
								<tr>
									<td align="center"><?php echo $cx->id_caixa  ?></td>
									<td align="center"><?php echo databr($cx->data_abertura) ?></td>
									<td align="center"><?php echo moedaBr($cx->valor_abertura) ?></td>
									<td align="center"><?php echo databr($cx->data_fechamento) ?></td>
									<td align="center"><?php echo moedaBr($cx->valor_vendido) ?></td>
									<td align="center"><?php echo $cx->status ?></td>
									<td align="center">
										<a href="<?php echo URL_BASE . "caixa/detalhes/" .$cx->id_caixa ?>" class="d-inline-block btn btn-outline-verde btn-pequeno"><i class="fas fa-edit"></i> Detalhes</a>
									</td>
								</tr>                    
							<?php } ?>	             
